...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    */
    private int getPriorityColor(int priority) {
        ...
        switch(priority) {
            case 3: priorityColor = ContextCompat.getColor(mContext, R.color.materialOrange);
                break;
            case 6: priorityColor = ContextCompat.getColor(mContext, R.color.materialOrange);
                break;
            case 12: priorityColor = ContextCompat.getColor(mContext, R.color.materialOrange);
                break;
            default: break;
        }
